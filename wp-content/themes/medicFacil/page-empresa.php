...
<main>
    <section class="banner">
        <div class="banner-text-wrapper">
            <h1 class="banner-title">Sua empresa agora é responsável<br> pela saúde mental dos colaboradores.<br> E a MedicFácil resolve isso com um clique.</h1>
            <p class="banner-text">Planos completos de assistência em saúde, com apoio psicológico, consultas online 24h e muito mais — a partir de R$ 29,90/mês por colaborador.</p>
        ...
        <div class="container">
            ...
            <div class="lei-features container">
                <div class="feature">
                    ...
                    <p class="feature-text">Cumpra a lei</p>
                </div>
                <div class="feature">
                    ...
                    <p class="feature-text">Valorize seus colaboradores</p>
                </div>
                <div class="feature">
                    ...
                    <p class="feature-text">Aumente a produtividade</p>
                </div>
                <div class="feature">
                    ...
                    <p class="feature-text">Reduza afastamentos e turnover</p>
                </div>
            </div>
            <div class="proposta-wrapper">
                <a href="#" class="proposta">QUERO UMA PROPOSTA PERSONALIZADA</a>
    ...
    <section class="plano">
        <div class="plano-wrapper container">
            <h2 class="plano-title">O plano de saúde mais completo e acessível do Brasil</h2>
            <p class="plano-text">Com a MedicFácil, sua equipe tem acesso facilitado a todas as ferramentas, informações e suporte necessários para oferecer um atendimento de excelência e operar com máxima eficiência.</p>

            <div class="plano-features">
                <?php for($i=1; $i <= 8; $i++): ?>
                    <div class="feature">
                        <img src="<?=get_template_directory_uri()?>/assets/images/consulta_medica_online_24h.webp" alt="plano">
                        <p class="feature-text">Consultas médicas online 24h</p>
                    </div>
                <?php endfor; ?>
            </div>
        </div>
    ...
    <section class="marketing">
        ...
        <div class="container">
            <div class="left-right-container">
                <div class="right">
                    <h2 class="marketing-title">Mais saúde é igual a mais crescimento</h2>
                    <p class="marketing-text">Empresas que investem em bem-estar têm até 25% mais produtividade, além de equipes mais engajadas e saudáveis.</p>
                </div>
                <div class="left">
        ...
        <div class="left-right-container">
            ...
            <div class="right">
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <div class="case">
                            <img src="<?=get_template_directory_uri()?>/assets/images/Dicolore_cliente.webp" alt="cliente Dicolore">
                            <p class="case-text">Economizei mais de R$ 8 mil no ano com o plano empresarial da Medic.” <span>– Indústria DiColore</span></p>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="case">
                            <img src="<?=get_template_directory_uri()?>/assets/images/Credfacil_clientes.webp" alt="cliente Credfacil">
                            <p class="case-text">”Com a MedicFácil reduzi 70% dos afastamentos e minha equipe ficou mais motivada.” <span>André Oliveira,diretor do grupo Credfácil</span></p>
                        </div>
                    </div>
                </div>
